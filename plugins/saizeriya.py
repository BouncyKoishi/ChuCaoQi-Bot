...
saizeriyaGDMenu = (
    ...
    SaizeriyaMenuItem(id=1380, name='培根菠萝小匹萨（6英寸）', price=15),
    ...
    SaizeriyaMenuItem(id=1375, name='罗勒酱小匹萨（6英寸）', price=15),
    SaizeriyaMenuItem(id=1377, name='四喜芝士小匹萨（6英寸）', price=15),
    SaizeriyaMenuItem(id=1376, name='菠菜温泉蛋小匹萨（6英寸）', price=18),
    SaizeriyaMenuItem(id=1374, name='塞拉诺火腿布拉塔佛卡夏（6英寸）', price=29),
    SaizeriyaMenuItem(id=1432, name='虾仁菜心奶汁烩饭', price=17),
    ...
    SaizeriyaMenuItem(id=1019, name='布拉塔芝士沙拉', price=16),
    ...
    SaizeriyaMenuItem(id=1280, name='托斯卡纳煮鱿鱼', price=16),
    ...
    SaizeriyaMenuItem(id=1378, name='玛丽娜拉小匹萨（6英寸）', price=12),
    ...
    SaizeriyaMenuItem(id=1743, name='布拉塔芝士配蜂蜜', price=10),
    ...
    SaizeriyaMenuItem(id=1748, name='浓郁巧克力配清爽薄荷冰淇淋', price=16),
