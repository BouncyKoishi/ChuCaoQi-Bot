INSERT INTO "kusaitemlist" VALUES ('G(东校区)', '东校区的G。', 'G', 0, 1, NULL, NULL, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('G(南校区)', '南校区的G。', 'G', 0, 1, NULL, NULL, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('G(北校区)', '北校区的G。附近的医院使G的波动趋于平缓。', 'G', 0, 1, NULL, NULL, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('G(珠海校区)', '珠海校区的G。', 'G', 0, 1, NULL, NULL, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('G(深圳校区)', '深圳校区的G。附近的工地使得G的波动较为剧烈。', 'G', 0, 1, NULL, NULL, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('草地', '用于生草的地块。你有多少块草地，手动生草就获得多少倍的草。', '财产', 0, 0, 1500, NULL, NULL, '草', 120, NULL);
INSERT INTO "kusaitemlist" VALUES ('生草机器', '自动生产草的机器。每天0点制造4~12个草。', '财产', 0, 0, 25, NULL, NULL, '草', 640, NULL);
INSERT INTO "kusaitemlist" VALUES ('生草工厂', '生产草的自动化工厂。每天0点制造640个草。', '财产', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO "kusaitemlist" VALUES ('量子护盾', '闪耀着蓝光的不稳定护盾。抽奖时使用，被口球的概率降低50%。', '道具', 1, 1, 800, 600, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('十连券', '印着“抽奖”字样的白色票据。允许你进行一次十连抽奖，十连抽奖不会获得口球，除此以外没有保底。', '道具', 1, 1, 32000, 24000, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('核心装配工厂', '自行装配自动化核心的工厂。每天0点生产4~12个自动化核心。', '财产', 0, 0, 250, NULL, NULL, '自动化核心', 15, NULL);
...
INSERT INTO "kusaitemlist" VALUES ('生草工业园区蓝图', '一张指导你如何建立生草产业链的蓝图。解锁建造“草精炼厂”的能力，可以使用"!草精炼厂"指令。', '图纸', 0, 0, 5000000, NULL, NULL, '草', 1, 'Lv4');
INSERT INTO "kusaitemlist" VALUES ('草精炼厂', '草产业链的基础，每天0点消耗5000个草，生成一个草之精华。你每有10个生草工厂，可以建设一个草精炼厂。', '财产', 1, 0, 500, NULL, NULL, '自动化核心', NULL, '生草工业园区蓝图');
INSERT INTO "kusaitemlist" VALUES ('生草质量I', '手动生草也能产出草之精华！每次生草有10%的概率产出一个草之精华。', '能力', 0, 0, 25, NULL, NULL, '草之精华', 1, NULL);
INSERT INTO "kusaitemlist" VALUES ('生草质量II', '掌握了一些从草地里收获草之精华的诀窍。每次生草产出草之精华的概率提高30%。', '能力', 0, 0, 200, NULL, NULL, '草之精华', 1, '生草质量I');
...
INSERT INTO "kusaitemlist" VALUES ('红茶', '添加了不明物质的红茶，和沼气池有某种玄学上的联系。如果当前存在沼气池，优化沼气池的效果，每次生草消耗一个。', '道具', 1, 1, 1919, 810, NULL, '草', NULL, '沼气池');
...
INSERT INTO "kusaitemlist" VALUES ('侦察凭证', '使用该凭证可以租借一次小除除部署的侦察卫星，探查其他人的仓库。使用"!仓库 qq=[被探查者qq]"的形式以使用凭证。', '道具', 0, 1, 10000, 5000, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('生草质量III', '有概率收获复数个草之精华了！每次生草产出草之精华的概率提高10%。每成功产出一个草之精华，额外进行一次草之精华产出判定。', '能力', 0, 0, 1000, NULL, NULL, '草之精华', 1, '生草质量II');
INSERT INTO "kusaitemlist" VALUES ('巨草基因图谱', '允许你生“巨草”。巨草比普通的草大一倍，草产量、生长用时、消耗土地承载力都是普通草的两倍。', '图纸', 0, 0, 800000, NULL, NULL, '草', 1, NULL);
...
INSERT INTO "kusaitemlist" VALUES ('草之精华构造图', '草之精华的基本结构图纸，或许可以指导草之精华的人工合成。允许你使用"!草压缩基地"指令。', '图纸', 0, 0, 5, NULL, NULL, '草之精华', 1, NULL);
...
INSERT INTO "kusaitemlist" VALUES ('生草预知', '生草控制论的成熟应用，不需要改造土地，只要已知草的幼苗状态就能完全预测草长成时的样子。生草时展示本次草和草精的精确产量。', '能力', 1, 0, 1000, NULL, NULL, '草之精华', 1, '初级生草预知');
...
INSERT INTO "kusaitemlist" VALUES ('高效草精炼指南', '早期草精炼探索者们留下的指南，给出了优化最初几个精炼厂精炼效率的方法。你的第X本指南会使你的第X个精炼厂获得草精产量+1。', '道具', 0, 0, 250000, NULL, 4.0, '草', 7, NULL);
INSERT INTO "kusaitemlist" VALUES ('高级十连券', '印着“抽奖”字样的蓝色票据。允许你进行一次十连抽奖，抽奖获得的物品最低为Normal等级。', '道具', 1, 1, 320000, 240000, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('特级十连券', '印着“抽奖”字样的金色票据。允许你进行一次十连抽奖，抽奖获得的物品最低为Hard等级。', '道具', 1, 1, 3200000, 2400000, NULL, '草', NULL, NULL);
...
INSERT INTO "kusaitemlist" VALUES ('骰子碎片', '重置你的命运。如果抽奖单抽获得的物品是已经拥有的，消耗一个骰子碎片，重新进行抽取。每次抽奖最多消耗50个骰子碎片。', '道具', 1, 1, 2500, 2000, NULL, '草', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('草精魔法入门', '借助草之精华的奇术性质，对草魔法进行更加深入的研究。可解锁后续的草精魔法。', '能力', 0, 0, 5, NULL, NULL, '草之精华', 1, 'Lv6');
INSERT INTO "kusaitemlist" VALUES ('纯酱的生草魔法', '魔法少女纯酱在生草时召唤了额外的草之精华喵(*^▽^)/★*☆
单次生草如果触发n连号，可以获得额外的草之精华，获取量为([x/2]+1)*2^(n-1)，其中x为本次连号数值，n为连号数量，且n≥3。', '能力', 0, 0, 50, NULL, NULL, '草之精华', 1, '草精魔法入门');
...
INSERT INTO "kusaitemlist" VALUES ('奖券印刷机', '每天自动印刷抽奖券的机器，有时候会印刷出传说中没有人见过的抽奖券。每天0点时有62.5％概率获得一张十连券，25％概率获得一张上级十连券，12.5％概率获得一张特级十连券。', '财产', 0, 0, 125, NULL, NULL, '草之精华', NULL, NULL);
INSERT INTO "kusaitemlist" VALUES ('奖券合成机', '获取幻之奖券必须的机器，同时也可以合成其他奖券。解锁“!合成 [奖券名称] [数量]”指令，每10个上级十连券可以合成1个特级十连券，每10个特级十连券可以合成1个天琴十连券。', '财产', 0, 0, 5000, NULL, NULL, '自动化核心', 1, NULL);
